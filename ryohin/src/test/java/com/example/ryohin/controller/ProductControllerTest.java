...
class ProductControllerTest {
    ...
    void setUp() {
        // --- テストデータ準備 ---
        productListItem1 = new ProductListItem(1, "リスト商品1", "/list1.png", 1000);
        productListItem2 = new ProductListItem(2, "リスト商品2",  "/list2.png", 2000);

        productDetail1 = new ProductDetail(1, "詳細商品1", "詳細説明1","木製",1000,"/detail1.png", 10);
        productDetailWithNulls = new ProductDetail(3, "詳細商品3", null,"金属製", 3000, null, 30); // descriptionとimageUrlがnull
    ...
    class GetAllProductsTests {
        ...
        void getAllProducts_WhenProductsExist_ShouldReturnProductList() throws Exception {
            ...
            mockMvc.perform(get("/api/products")
                    ...
                    .andExpect(jsonPath("$[0].productName", is(productListItem1.getProductName())))
                    ...
                    .andExpect(jsonPath("$[1].productName", is(productListItem2.getProductName())))
    ...
    class GetProductByIdTests {
        ...
        void getProductById_WhenProductExists_ShouldReturnProductDetail() throws Exception {
            ...
            mockMvc.perform(get("/api/products/{productId}", productId)
                    ...
                    .andExpect(jsonPath("$.productName", is(productDetail1.getProductName())))
        ...
        void getProductById_WhenProductExistsWithNullFields_ShouldReturnProductDetailWithNulls() throws Exception {
            ...
            mockMvc.perform(get("/api/products/{productId}", productId)
                    ...
                    .andExpect(jsonPath("$.productName", is(productDetailWithNulls.getProductName())))
