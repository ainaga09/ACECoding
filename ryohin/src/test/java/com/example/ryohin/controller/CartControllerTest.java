...
class CartControllerTest {
    ...
    void setUp() {
        ...
        CartItemDto item1 = new CartItemDto( 1, "カート商品1", 1000, 2, 2000);
    ...
    class GetCartTests {
        ...
        void getCart_WhenCartExists_ShouldReturnCartWithStatusOk() throws Exception {
            ...
            mockMvc.perform(get("/api/cart")
                    ...
                    .andExpect(jsonPath("$.items.1.productName", is("カート商品1")))
    ...
    class UpdateItemTests {
        ...
        void updateItem_WithValidData_ShouldReturnUpdatedCartWithStatusOk() throws Exception {
            ...
            CartItemDto updatedItem = new CartItemDto(1, "カート商品1", 1000,  5, 5000);
